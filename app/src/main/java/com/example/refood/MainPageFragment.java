...
public class MainPageFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (NetworkUtils.isNetworkConnected(getContext())) {
            ...
            imageView_recipe_of_the_day.setImageDrawable(shimmerDrawable);
                                ...
                                if (post.getIsLocal()) {
                                    ...
                                    mainImageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            Glide.with(getActivity().getApplicationContext()).load(imageURL).placeholder(shimmerDrawable).into(imageView_recipe_of_the_day);
                                        }
                                    });
                                }
                            } else {
